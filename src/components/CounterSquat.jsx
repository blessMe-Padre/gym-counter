...
export default function CounterSquat({ count, squat, squatMonth, currentMonth }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const writeUserDataSquat = (generalSquat, generalSquatMonth, count, email) => {
        ...
        writeUserDataSquat(generalSquat, generalSquatMonth, count, email);
        setValue(0);
    }
    return (
        <>
